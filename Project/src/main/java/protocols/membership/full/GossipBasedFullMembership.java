...
public class GossipBasedFullMembership extends GenericProtocol {
    ...
    public GossipBasedFullMembership(Properties props, Host self) throws IOException, HandlerRegistrationException {
    ...
    private void uponSample(SampleMessage msg, Host from, short sourceProto, int channelId) {
        ...
        // membership (in the connectionUp callback)
    ...
    private void uponSampleTimer(SampleTimer timer, long timerId) {
        // When the SampleTimer is triggered, get a random peer in the membership and
        // send a sample
