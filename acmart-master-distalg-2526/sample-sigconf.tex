...
\title{Your Amazing Title that Will Generate Big Expectations}
...
\author{Endi--Mon}
\authornote{Student number 66666. Endi was quite lazy and did not did much on this.}
\email{endi@lazzy.net}
\affiliation{%
  \institution{MEI, DI, FCT, UNL}
}

\author{Void Emperor}
\authornote{Student number 77777. Void did stress a lot about this project, he made lots of phone calls and pushed hard for people to work.}
\email{lvoid@stress.in}
\affiliation{%
  \institution{MEI, DI, FCT, UNL}
}
...
\renewcommand{\shortauthors}{Endi, Void, and Marbles.}
