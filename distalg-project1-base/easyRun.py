...
cmd10101 = f'wsl bash -c "cd {BASE_PATH} && java -jar target/DistAlg.jar babel.address=172.30.191.253 babel.port=10101"'
cmd10102 = f'wsl bash -c "cd {BASE_PATH} && java -jar target/DistAlg.jar babel.address=172.30.191.253 babel.port=10102 contact={IP}:10101"'
cmd10103 = f'wsl bash -c "cd {BASE_PATH} && java -jar target/DistAlg.jar babel.address=172.30.191.253 babel.port=10103 contact={IP}:10101"'
cmd10104 = f'wsl bash -c "cd {BASE_PATH} && java -jar target/DistAlg.jar babel.address=172.30.191.253 babel.port=10104 contact={IP}:10102"'
